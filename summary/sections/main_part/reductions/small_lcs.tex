...
For the first reduction, we assume $\alpha_\delta = \alpha_m$ and $\alpha_M = 2$. %, i.e., the number of deleted symbols in the smaller string is asymptotically the same as its length.
